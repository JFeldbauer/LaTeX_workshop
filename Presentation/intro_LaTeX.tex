...
\begin{columns}
  ...
  \begin{column}{0.2\textwidth}
    \begin{tikzpicture}
      \draw [decorate,decoration={brace,mirror,amplitude=10pt},xshift=0pt,yshift=0pt] (-3,4.3) -- (-3,4.6) node[black,midway,xshift=1.5cm]{\footnotesize Documentclass};\pause
      \draw [decorate,decoration={brace,mirror,amplitude=10pt},xshift=0pt,yshift=0pt] (-3,2.8) -- (-3,4.1) node[black,midway,xshift=1.5cm]{\footnotesize Preamble};\pause
      \draw [decorate,decoration={brace,mirror,amplitude=10pt},xshift=0pt,yshift=0pt] (-3,-2.2) -- (-3,2.5) node[black,midway,xshift=1.5cm]{\footnotesize Document};
    \end{tikzpicture}
  \end{column}
\end{columns}
\end{frame}
